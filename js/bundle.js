    ...
    render() {
      ...
      element.innerHTML = `
                ...
                <div class="menu__item-price">
                    ...
                    <div class="menu__item-total"><div class="menu__item-total"><span>${Math.round(
                      this.price
                    )}</span> руб/день</div>
                </div>
            `;
...
function localSt() {
  //added data setting in local storage///
...
/*!**********************!*\
  !*** ./js/script.js ***!
  \**********************/
const localSt = __webpack_require__(/*! ./modules/localSt */ "./js/modules/localSt.js");
...
window.addEventListener("DOMContentLoaded", () => {
  const tabs = __webpack_require__(/*! ./modules/tabs */ "./js/modules/tabs.js"),
    ...
    localSt = __webpack_require__(/*! ./modules/localSt */ "./js/modules/localSt.js"),
